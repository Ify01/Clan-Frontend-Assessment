...
const Summary = () => {
  ...
  return (
    <div className="sm:basis-[60%] w-[300px] sm:w-[100%] h-[100%] sm:pr-[80px] text-center">
      ...
      <div className="bg-neutral-alabaster rounded-lg p-5 overflow-scroll h-48">
      ...
      <div className="flex justify-between p-5 ">
        ...
        {selectedAddOnsValue.map((item) => {
          return (
            <div key={item.id} className="text-primary-purplishBlue font-[800]">
              +${selectedMonthlyPlan.price + item.price} /mo
            </div>
          );
        })}
      </div>

      <div className="flex justify-around sm:justify-between items-center pt-[160px] sm:pt-[79px]">
        <button
